...
public class HiFiScrollBarUI extends XPScrollBarUI {
    ...
    protected void installDefaults() {
        ...
        Color colors[] = BaseLookAndFeel.getTheme().getThumbColors();
    ...
    protected Color getFrameColor() {
        Color frameColor = ColorHelper.brighter(BaseLookAndFeel.getTheme().getButtonBackgroundColor(), 8);
        if (isDragging) {
