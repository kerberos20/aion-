...
public class BaseTitlePane extends JComponent implements TitlePane {
    ...
    protected Image getFrameIconImage() {
        ...
        if (getFrame() == null && Utilities.getJavaVersion() >= 1.6) {
    ...
    public void addNotify() {
        ...
        if (window != null) {
            ...
            setActive(Utilities.isWindowActive(window));
            installListeners();
        }
    }
    ...
    public void iconify() {
        ...
        if (frame != null) {
            if (Utilities.isMac() && Utilities.getJavaVersion() >= 1.7) {
    ...
    protected boolean isActive() {
        return (window == null) ? true : Utilities.isWindowActive(window);
    }
    ...
    public void paintText(Graphics g, int x, int y, String title) {
        ...
        Utilities.drawString(rootPane, g, title, x, y);
    }
...
//-----------------------------------------------------------------------------------------------
    protected class SystemMenuBar extends JMenuBar {
        ...
        protected int computeHeight() {
            FontMetrics fm = Utilities.getFontMetrics(this, null, getFont());
...
//-----------------------------------------------------------------------------------------------
    protected class TitlePaneLayout implements LayoutManager {
        ...
        protected int computeHeight() {
            FontMetrics fm = Utilities.getFontMetrics(BaseTitlePane.this, null, getFont());
            return fm.getHeight() + 6;
        }
...
//-----------------------------------------------------------------------------------------------
    protected class WindowHandler extends WindowAdapter {
        ...
        public void windowDeiconified(WindowEvent e) {
            if (Utilities.isMac() && Utilities.getJavaVersion() >= 1.7 && wasMaximized) {
                SwingUtilities.invokeLater(new Runnable() {
