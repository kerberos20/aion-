        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (c instanceof JCheckBoxMenuItem) {
                ...
                if (button.isEnabled()) {
                    ...
                    g.setColor(ColorHelper.brighter(BaseLookAndFeel.getFrameColor(), 40));
                }
                g.drawRect(x, y, w, h);
            } else {
                if (button.isEnabled()) {
                    if ((button.isRolloverEnabled() && model.isRollover())) {
                        ...
                        if (BaseLookAndFeel.getTheme().doShowFocusFrame() && button.hasFocus()) {
                            Utilities.fillHorGradient(g, BaseLookAndFeel.getTheme().getFocusColors(), x, y, w, h);
                        } else {
                            Utilities.fillHorGradient(g, BaseLookAndFeel.getTheme().getCheckBoxColors(), x, y, w, h);
                        }
                        if (!model.isPressed()) {
                            g.setColor(Color.white);
                    ...
                    if (BaseLookAndFeel.getTheme().doShowFocusFrame() && button.hasFocus()) {
                        Color hiColor = ColorHelper.brighter(BaseLookAndFeel.getTheme().getFocusFrameColor(), 30);
                        Color loColor = ColorHelper.darker(BaseLookAndFeel.getTheme().getFocusFrameColor(), 20);
                        g.setColor(hiColor);
                    ...
                    Utilities.fillHorGradient(g, BaseLookAndFeel.getTheme().getDisabledColors(), x, y, w, h);
                    g.setColor(ColorHelper.brighter(BaseLookAndFeel.getFrameColor(), 40));
                    g.drawRect(x, y, w, h);
                }
            }
            ...
            if (model.isPressed() && model.isArmed()) {
                Color bc = BaseLookAndFeel.getTheme().getSelectionBackgroundColor();
...
//-----------------------------------------------------------------------------------------------------------
    public static class IconSymbol implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            boolean active = Utilities.isActive((JComponent) c);
