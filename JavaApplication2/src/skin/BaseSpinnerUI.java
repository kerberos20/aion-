...
public class BaseSpinnerUI extends BasicSpinnerUI {
    ...
    protected Component createNextButton() {
        ...
        if (Utilities.isLeftToRight(spinner)) {
            Border border = BorderFactory.createMatteBorder(0, 1, 1, 0, BaseLookAndFeel.getFrameColor());
            button.setBorder(border);
        } else {
            Border border = BorderFactory.createMatteBorder(0, 0, 1, 1, BaseLookAndFeel.getFrameColor());
            button.setBorder(border);
        }
        ...
        public void paint(Graphics g) {
            ...
            if (isEnabled()) {
                ...
                if (model.isPressed() && model.isArmed()) {
                    ...
                    else if (Utilities.isFrameActive(this))
            ...
            Utilities.fillHorGradient(g, colors, 0, 0, getWidth(), getHeight());
            paintBorder(g);
