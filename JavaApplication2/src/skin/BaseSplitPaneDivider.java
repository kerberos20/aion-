...
public class BaseSplitPaneDivider extends BasicSplitPaneDivider {
    ...
    public Color getRolloverColor() {
        return ColorHelper.darker(BaseLookAndFeel.getTheme().getRolloverColor(), 16);
    }
    ...
    public void paint(Graphics g) {
        if (!isFlatMode()) {
            ...
            Color color = BaseLookAndFeel.getBackgroundColor();
            ...
            if (UIManager.getLookAndFeel() instanceof BaseLookAndFeel) {
                ...
                if (orientation == JSplitPane.HORIZONTAL_SPLIT) {
                    Utilities.fillVerGradient(g, colors, 0, 0, width, height);
    ...
    protected JButton createLeftOneTouchButton() {
        JButton b = new JButton() {
            ...
            public void paint(Graphics g) {
                ...
                Icon icon;
                if (UIManager.getLookAndFeel() instanceof BaseLookAndFeel) {
                    BaseLookAndFeel lf = (BaseLookAndFeel) UIManager.getLookAndFeel();
                    if (orientation == JSplitPane.HORIZONTAL_SPLIT) {
                ...
                if (getModel().isArmed()) {
                    if (getModel().isPressed()) {
                        Utilities.draw3DBorder(g, ColorHelper.darker(color, 30), ColorHelper.brighter(color, 80), 0, 0, w, h);
                    } else {
                        Utilities.draw3DBorder(g, ColorHelper.brighter(color, 80), ColorHelper.darker(color, 30), 0, 0, w, h);
                    }
                }
            }
