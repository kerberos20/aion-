...
public abstract class BaseTheme extends MetalTheme {
    ...
    public static final ColorUIResource SUPERLIGHTGREY = new ColorUIResource(248, 248, 248);
    public static final ColorUIResource EXTRALIGHTGREY = new ColorUIResource(232, 232, 232);
    ...
    public void setUpColor() {
        ...
        macStyleWindowDecoration = Utilities.isMac();
        centerWindowTitle = Utilities.isWindows() && Utilities.getOSVersion() >= 6.2;
        linuxStyleScrollBar = !Utilities.isWindows();
        macStyleScrollBar = Utilities.isMac();
        dynamicLayout = true;
        textShadow = false;
        ...
        rolloverColor = EXTRALIGHTGREY;
        rolloverColorLight = WHITE;
        rolloverColorDark = EXTRALIGHTGREY;
        ...
        windowTitleColorLight = EXTRALIGHTGREY;
        ...
        windowInactiveTitleBackgroundColor = EXTRALIGHTGREY;
        windowInactiveTitleColorLight = WHITE;
        windowInactiveTitleColorDark = EXTRALIGHTGREY;
        windowInactiveBorderColor = EXTRALIGHTGREY;

        menuForegroundColor = BLACK;
        menuBackgroundColor = EXTRALIGHTGREY;
        menuSelectionForegroundColor = BLACK;
        menuSelectionBackgroundColor = LIGHTGRAY;
        menuSelectionBackgroundColorLight = EXTRALIGHTGREY;
        menuSelectionBackgroundColorDark = LIGHTGRAY;
        menuColorLight = EXTRALIGHTGREY;
    ...
    public FontUIResource getControlTextFont() {
        if (controlFont == null) {
            if (Utilities.isLinux() && Utilities.isHiresScreen()) {
