...
public class BaseScrollButton extends BasicArrowButton {
    ...
    public void paint(Graphics g) {
        ...
        if ((getDirection() == NORTH) || (getDirection() == SOUTH)) {
            Utilities.fillVerGradient(g2D, colors, 0, 0, width, height);
        } else {
            Utilities.fillHorGradient(g2D, colors, 0, 0, width, height);
        }
        ...
        Utilities.draw3DBorder(g2D, frameColorLo, ColorHelper.darker(frameColorLo, 10), 0, 0, width, height);
