            ...
            focusListener = new FocusListener() {
                ...
                public void focusGained(FocusEvent e) {
                    if (getComponent() != null) {
                        ...
                        if (laf instanceof BaseLookAndFeel && orgBorder instanceof UIResource) {
    ...
    protected void paintBackground(Graphics g) {
        ...
        if (BaseLookAndFeel.getTheme().doShowFocusFrame()) {
            if (getComponent().hasFocus() && getComponent().isEditable()) {
                g.setColor(BaseLookAndFeel.getTheme().getFocusBackgroundColor());
            }
        }
    ...
    private void updateBackground() {
        ...
        if (c.getBackground() instanceof UIResource) {
            if (!c.isEnabled() || !c.isEditable()) {
                c.setBackground(BaseLookAndFeel.getDisabledBackgroundColor());
            } else {
                c.setBackground(BaseLookAndFeel.getInputBackgroundColor());
            }
        }
    }
}
