...
import skin.BaseButtonListener;
import java.awt.*;
import javax.swing.*;
...
public class BaseToggleButtonUI extends BasicToggleButtonUI {
    ...
    protected void paintBackground(Graphics g, AbstractButton b) {
        ...
        if (b.isEnabled()) {
            ...
            if (background instanceof ColorUIResource) {
                if (b.isRolloverEnabled() && model.isRollover()) {
                    ...
                    if (BaseLookAndFeel.getTheme().doShowFocusFrame() && b.hasFocus()) {
        ...
        Utilities.fillHorGradient(g, colors, 1, 1, width - 2, height - 2);
    }
    ...
    protected void paintText(Graphics g, AbstractButton b, Rectangle textRect, String text) {
        ...
        if (model.isEnabled()) {
            ...
            if (sc instanceof Color) {
                g.setColor((Color)sc);
                Utilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x + offs, textRect.y + fm.getAscent() * offs + 1);
            }
            g.setColor(foreground);
            Utilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x + offs, textRect.y + fm.getAscent() + offs);
        } else {
            g.setColor(Color.white);
            Utilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x + 1, textRect.y + fm.getAscent() + 1);
            g.setColor(BaseLookAndFeel.getDisabledForegroundColor());
            Utilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x, textRect.y + fm.getAscent());
        }
    }
